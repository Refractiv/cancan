= CanCan
{<img src="https://secure.travis-ci.org/clemensg/cancan.png?branch=master" />}[http://travis-ci.org/clemensg/cancan] 
...
This is a fork of {cancan}[http://github.com/ryanb/cancan] and should be considered experimental until further notice.
...
User permissions are defined in an +Ability+ class. CanCan 1.5 includes a generator for creating this class.
